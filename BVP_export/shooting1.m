...
%
% solve the boundary value problems u''=f(t,u,u'), u(a)=alpha, u(b)=beta
% The shooting method is used, together with a secant method
% [s(1) s(2)] are the initial values for u'(a)
%
